...
class seoContentModel extends My_model
{
    ...
    public function __construct(){
    	parent::__construct();
    	$this->table = config('constants.SEOCONTENT_TABLE');
    }
    ...
    public function getRecordDetails( $whereData = [] , $likeData = [] , $additionalData = [] ){
    	...
    	$query = seoContentModel::where('t_is_deleted', config('constants.INACTIVE_STATUS'));
