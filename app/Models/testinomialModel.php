...
class testinomialModel extends My_model
{
    ...
    public function __construct(){
    	parent::__construct();
    	$this->table = config('constants.TESTINOMIAL_TABLE');
    }
    ...
    public function getRecordDetails( $whereData = [] , $likeData = [] , $additionalData = [] ){
    	...
    	$query = testinomialModel::where('t_is_deleted', config('constants.INACTIVE_STATUS'));
