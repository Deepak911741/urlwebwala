...
class newLatterModel extends My_model
{
    ...
    public function __construct(){
    	parent::__construct();
    	$this->table = config('constants.NEWSLATTER_TABLE');
    }
    ...
    public function getRecordDetails( $whereData = [] , $likeData = [] , $additionalData = [] ){
    	...
    	$query = newLatterModel::where('t_is_deleted', config('constants.INACTIVE_STATUS'));
