...
class blogModel extends My_model
{
    ...
    public function __construct(){
    	parent::__construct();
    	$this->table = config('constants.BLOG_TABLE');
    }

	public function categoryInfo(){
		return $this->belongsTo(categoryModel::class , 'i_category_id');
	}
    ...
    public function getRecordDetails( $whereData = [] , $likeData = [] , $additionalData = [] ){
    	...
    	$query = blogModel::where('t_is_deleted', config('constants.INACTIVE_STATUS'));
