...
<div class="body-overlay"></div>
    ...
    <div class="tp-sv-page-feature-area black-bg p-relative pt-120 pb-120">
        <div class="sv-page-fea-img-1" data-background="{{ asset ('public/images/services/image13.png')}}"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
    ...
    <div class="tp-sv-page-feature-area black-bg p-relative pt-120 pb-120">
        <div class="sv-page-fea-img-2" data-background="{{ asset ('public/images/services/media.jpg')}}"></div>
        <div class="container">
            <div class="row">
    ...
    <div class="tp-sv-page-feature-area black-bg p-relative pt-120 pb-120">
        <div class="sv-page-fea-img-1" data-background="{{ asset ('public/images/services/business.jpg')}}"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="tp-sv-fea-ab-content mr-60">
    ...
    <div class="tp-sv-page-feature-area black-bg p-relative pt-120 pb-120">
        <div class="sv-page-fea-img-2" data-background="{{ asset ('public/images/services/menu1.jpg')}}"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    <div class="tp-sv-fea-ab-content ml-80">
